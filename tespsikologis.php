...
<html lang="en">
  <head>
    ...
    <!-- My CSS -->
    <link rel="stylesheet" href="style/styletes.css">
  ...
  <body>
    ...
    <div class='list awal banget'><p><center><img src ="gambar/tes1.png" align="middle" ></center></p>
    <p class='list-title'> Tes tipe produktivitas : Kembangkan Potensi Diri </p>
   <p class='list-description'> Kamu merasa gitu-gitu aja?? mau merasa lebih produktif?! cobain tes ini dan temukan tipe produktifmu :) </p>
   <a class="btn btn-warning tombol" href="#">Ikuti Tes</a>
</div>

<div class='list tengah'> <p><center><img src ="gambar/tes2.png" align="middle" ></center></p>
   <p class='list-title'> Tes Kejujuran : Mungkin kamu pernah berbohong</p>
   <p class='list-description'> Setiap Orang pernah berbohong,tapi seberapa besarkah kamu menggunakan kebohonganmu? Cari tahu disini! </p>
   <a class="btn btn-warning tombol" href="#">Ikuti Tes</a>
</div>
<div class='list tengah'> <p><center><img src ="gambar/tes3.png" align="middle" ></center></p>
   <p class='list-title'> Tes Sehat Mental </p>
   <p class='list-description'> Bagaimana kabarmu akhir-akhir ini? Cek kondisi kesehatanmu disini yuk! </p>
   <br>
   <br>
   <a class="btn btn-warning tombol" href="#">Ikuti Tes</a>
</div>
<div class='list terakhir banget'>   <p><center><img src ="gambar/tes4.png" align="middle" ></center></p>
   <p class='list-title'> Tes Kelebihan dan Kekuatan Diri : Superpower Check! </p>
   <p class='list-description'> Belum tau apa kekuatan dirimu? Coba ikuti tes kekuatan untuk mengikuti kekuatan dirimu! </p>
   <a class="btn btn-warning tombol" href="#">Ikuti Tes</a>
</div>
