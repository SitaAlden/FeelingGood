...
<html lang="en">
  ...
  <body>
    ...
    <!-- Akhir Navbar -->
    <br>
    <h2 align="center"> Update Data Riwayat Pasien </h2>
    <div class="container" style="margin-top: 50px">
      <div class="row">
        <div class="col-md-8 offset-md-2">
          <div class="card">
            <div class="card-header">
              UPDATE DATA RIWAYAT PASIEN
            </div>
            <div class="card-body">
              <form action="update_riwayatpasien.php" method="POST">
                
                <div class="form-group">
                  <label>Nama Pasien</label>
                  <input type="text" name="nama_pasien" value="<?php echo $row['nama_pasien'] ?>" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="no_wa" value="<?php echo $row['no_wa'] ?>" class="form-control">
                </div>

                <div class="form-group">
                  <label>ID Psikolog</label>
                  <input type="text" name="id_psikolog" value="<?php echo $row['id_psikolog'] ?>"  class="form-control">
                </div>

                <div class="form-group">
                  <label>Nama Psikolog</label>
                  <input type="text" name="nama_psikolog" value="<?php echo $row['nama_psikolog'] ?>" class="form-control">
                </div>

                <div class="form-group">
                  <label>Catatan</label>
                  <input type="text" name="catatan" value="<?php echo $row['catatan'] ?>" class="form-control">
                </div>
