...
//error_reporting(0); 
  ...
  $query = "SELECT * FROM jadwal_pertemuan WHERE id_jadwal = $id LIMIT 1"; 
...
<html lang="en">
  ...
  <body>
    ...
    <!-- Akhir Navbar -->
    <br>
    <h2 align="center"> Update Konsultasi Jadwal Pertemuan </h2>
    <div class="container" style="margin-top: 50px">
      <div class="row">
        <div class="col-md-8 offset-md-2">
          <div class="card">
            <div class="card-header">
              UPDATE DATA JADWAL KONSULTASI
            </div>
            <div class="card-body">
              <form action="update_jadwal.php" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="no_pengguna" value="<?php echo $row['no_pengguna'] ?>" placeholder="Masukkan Nomor Pengguna" class="form-control">
                  <input type="hidden" name="id_jadwal" value="<?php echo $row['id_jadwal'] ?>">
                </div>

                <div class="form-group">
                  <label>Nama Pengguna</label>
                  <input type="text" name="nama_pengguna" value="<?php echo $row['nama_pengguna'] ?>" placeholder="Masukkan Nama Pengguna" class="form-control">
                </div>

                <div class="form-group">
                  <label>No Whatsapp</label>
                  <input type="text" name="no_wa" value="<?php echo $row['no_wa'] ?>" placeholder="Masukkan Nomor Whatsapp pengguna" class="form-control">
                </div>

                <div class="form-group">
                  <label>ID Psikolog</label>
                  <input type="text" name="id_psikolog" value="<?php echo $row['id_psikolog'] ?>"  placeholder="Masukkan Nomor Pengguna" class="form-control">
                </div>

                <div class="form-group">
                  <label>Nama Psikolog</label>
                  <input type="text" name="nama_psikolog" value="<?php echo $row['nama_psikolog'] ?>" placeholder="Masukkan Nama Pengguna" class="form-control">
                </div>

                <div class="form-group">
                  <label>No Telp Psikolog</label>
                  <input type="text" name="no_telp_psikolog" value="<?php echo $row['no_telp_psikolog'] ?>" placeholder="Masukkan Nomor Telpon Psikolog" class="form-control">
                </div>

                <div class="form-group">
                  <label>Jadwal Pertemuan</label>
                  <input type="date" name="jadwal"  value="<?php echo $row['jadwal'] ?>" placeholder="Masukkan Tanggal" class="form-control">
                </div>
