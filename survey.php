...
<html lang="en">
  ...
  <body>
    ...
    <div class='list awal banget'><p><center><img src ="gambar/survey1.png" align="middle" ></center></p>
    <p class='list-title'> Sita Alden <br> 20 Tahun <br> Mahasiswa Unsika</p>
   <p class='list-description'> Sesi mentoringnya sangat menyenangkan dan bisa memberi pengetahuan baru untukku 
     tentang bagaimana cara kita mengendalikan diri sendiri, berdamai dengan keadaan dan bersikap lebih asertif 
     dalam memyampaikan pendapat, Makasih satu persen udah menyediakan wadah untuk aku bisa bercerita tanpa takut dihakimi </p>
  
</div>

<div class='list tengah'> <p><center><img src ="gambar/survey2.png" align="middle" ></center></p>
   <p class='list-title'> Lee Min Ho <br> 33 Tahun <br> Mahasiswa Hankuk Korea</p>
   <p class='list-description'> Melegakan banget setelah ikutan mentoring, 
     dikasih saran-saran bagus buat memperbaiki diri juga. Terimakasih banyak untuk tim FeelingGood dan para mentor! </p>

</div>

<div class='list terakhir banget'>   <p><center><img src ="gambar/survey3.png" align="middle" ></center></p>
   <p class='list-title'> Yuli Nur Atifah <br> 20 Tahun <br> Mahasiswa Unsika</p>
   <p class='list-description'> Setelah mentoring jadi berasa dapet pencerahan untuk memikirkan solusi masalah. 
     Banyak juga ilmu baru yang didapet setelah mentoring. 
     Harapanku terwujud untuk dapetin langkah solutif dari masalah yang lagi dihadepin. </p>
