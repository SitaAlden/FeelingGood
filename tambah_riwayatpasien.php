...
<html lang="en">
  ...
  <body>
    ...
    <!-- Akhir Navbar -->
    <br>
    <h2 align="center"> Tambah Data Riwayat Pasien </h2>
    <div class="container" style="margin-top: 50px">
      <div class="row">
        <div class="col-md-8 offset-md-2">
          <div class="card">
            <div class="card-header">
              TAMBAH DATA RIWAYAT PASIEN
            </div>
            <div class="card-body">
              <form action="simpan_riwayatpasien.php" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="email" name="username" placeholder="Masukkan email" class="form-control">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="id_psikolog" placeholder="Masukkan Id Psikolog" class="form-control">
                </div>

                <div class="form-group">
                  <label>Nama Psikolog</label>
                  <input type="text" name="nama_psikolog" placeholder="Masukkan Nama Psikolog" class="form-control">
                </div>

                <div class="form-group">
                  <label>Catatan</label>
                  <input type="text" name="catatan" placeholder="Masukkan catatan pasien" class="form-control">
                </div>
